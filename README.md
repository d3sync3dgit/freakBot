...
Including:
* Moderate support for admin commands (Timeout command, Ban/Kick, etc)
* Fully working database for registering users (Including rankings, Level of trust, and commands for tracking, adding/removing users)
